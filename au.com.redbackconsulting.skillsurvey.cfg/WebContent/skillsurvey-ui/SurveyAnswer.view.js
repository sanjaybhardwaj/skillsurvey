sap.ui.jsview("skillsurvey-ui.SurveyAnswer", {
	...
	*/ 
	createContent : function(oController) {
		...
		oLabel =  new sap.m.Label({ text : "UOC_QuestionId:"	});
		
		oNameInput =new sap.m.InputBase({
			id : "surveyansweruocid",
			width:"250px",
		...
		oLabel = new sap.m.Label({	text : "SurveyID:"	});
		oNameInput =new sap.m.InputBase({
			id : "surveyanswersurveyid",
			width:"250px",
		...
		oLabel = new sap.m.Label({text : "Value_AnsweredAt:"	});
		oNameInput =new sap.m.InputBase({
			id : "surveyanswervalueansweredat",
			width:"250px",
...
//		}, this);
		var oObjecthead = new sap.m.ObjectHeader({
			...
			title: "SurveyAnswer Information"
		});
		///oObjecthead.s
