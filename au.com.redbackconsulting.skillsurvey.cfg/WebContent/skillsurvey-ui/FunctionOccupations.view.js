sap.ui.jsview("skillsurvey-ui.FunctionOccupation", {
	...
	*/ 
	getControllerName : function() {
		return "skillsurvey-ui.FunctionOccupation";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		oNameInput =new sap.m.InputBase({
			id : "functionoccupationfunctionid",
			width:"250px",
...
//		}, this);
		var oObjecthead = new sap.m.ObjectHeader({
			...
			title: "FunctionOccupations Information"
		});
		///oObjecthead.s
